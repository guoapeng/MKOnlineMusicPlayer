...
var musicList = [
    ...
    {
        name: "播放历史",   // 播放列表名字
        cover: "src/images/history.png",          // 播放列表封面
        creatorName: "",        // 列表创建者名字
        creatorAvatar: "",      // 列表创建者头像
        item: []
    },  
        ...
        item: [                 // 这里面放歌曲
            {
                ...
                url: "https://www.pengtech.net/lyrics/content/songs/na_ge.mp3"   // mp3链接（此项建议不填，除非你有该歌曲的比较稳定的外链）
            },
            // 下面演示插入各个平台的音乐。。。
            {
                id: "65528",
                ...
                url: "https://www.pengtech.net/lyrics/content/songs/ni_neng_ting_jian_ma.mp3"
            },
            {
                id: "001JD1SR29d1hS",
                name: "特别的爱给特别的你",
                ...
                url: "https://www.pengtech.net/lyrics/content/songs/gong_zhu_de_tian_tang.mp3"     // 腾讯的外链有效期较短，插入时 url [必须]设置空值，播放时再临时抓取
            },
            {
                id: "81175",
                name: "让我欢喜让我忧",
                ...
                url: "https://www.pengtech.net/lyrics/content/songs/na_nian_chu_xia.mp3"     // 虾米的外链有效期较短，插入时 url [必须]设置空值，播放时再临时抓取
            },
            {
            ...
            },
            {
                ...
                url: "https://www.pengtech.net/lyrics/content/songs/closer_to_me.mp3"         // 百度的外链有效期较短，插入时 url [必须]设置空值，播放时再临时抓取
            }  // 列表中最后一首歌大括号后面不要加逗号
        ]
    },
    // 方式二：直接提供网易云歌单ID
